...
export const brand = defineBrand({
	...
	colors: [
		...
		},
		{
			...
			hex: '#ef3800',
			cmyk: [0, 87, 100, 0],
			usage: 'One accent, used sparingly: calls to action, headers, highlights.',
			tints: true,
		},
		{
			id: 'graphite',
	...
	typography: {
		...
		scale: [
			...
			},
			{
				...
				sample: 'Through collaborative thinking we help our clients to clarify and grow their brand.',
			},
			{
				name: 'Heading 2.0',
	...
	contact: {
		...
		socials: [
			{ label: 'Instagram', handle: '@typefool', url: 'https://instagram.com/typefool' },
			{ label: 'Behance', handle: '@typefool', url: 'https://behance.net/typefool' },
		],
	},

	/** Shown on the home page. Drop the real files into `public/brand/`. */
	downloads: [
		{ label: 'Logo pack', href: '/brand/logotype-dark.svg', format: 'SVG', note: 'Logotype and brandmark, all approved colourways.' },
		{ label: 'This document', href: '/', format: 'PDF', note: 'Replace with an exported PDF of the guidelines.' },
	],
